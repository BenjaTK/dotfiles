...
local music = browser .. " www.tidal.com"
local launcher = "rofi -show drun -show-icons"
local runner = "rofi -show run"
local screenshotter = "flameshot gui"
...
hl.bind(secondMod .. " + S", hl.dsp.exec_cmd(screenshotter))
...
hl.bind(secondMod .. " + I", hl.dsp.window.move({ workspace = "special:magic" }))
